...
const workProjects = [
  ...
  { id: 8, image: '/8.jpeg', title: '3D Sign Board', description: 'Premium custom 3D sign boards crafted with precision to give your brand a bold, illuminated, and professional physical presence.' },
  ...
  { id: 12, image: '/12.jpeg', title: 'Treet Kandolas Distribution', description: 'Strategic branding and distribution of Treet retail kandolas (gondolas) to optimize in-store product placement and maximize brand visibility.' },
  { id: 13, image: '/13.jpeg', title: 'Treet Branding Carts Distribution', description: 'Comprehensive branding and strategic distribution of Treet mobile carts to enhance on-the-go brand visibility and consumer reach.' },
  { id: 14, image: '/14.jpeg', title: 'Treet Estela Kiosk production and execution', description: 'End-to-end custom fabrication and flawless on-site execution of the Treet Estela kiosk, designed to maximize brand engagement.' },
  { id: 15, image: '/15.jpeg', title: '3D Sign Board', description: 'Eye-catching custom 3D sign board designed to elevate your brand\'s visibility and professional appeal.' },
  { id: 16, image: '/16.jpeg', title: 'MTJ Kiosk Production & Execution', description: 'Expert roofing replacement with high-efficiency thermal insulation layer.' },
  { id: 17, image: '/17.jpeg', title: '3D Signage', description: 'Optimization of heating and cooling systems for maximum energy savings.' },
  { id: 18, image: '/18.jpeg', title: 'Oxford College Digital Board', description: 'Design and installation of high-impact digital billboards for Oxbridge College, Islamabad.' },
            ...
            {visibleProjects.map((project) => (
              ...
              >
                <div className="aspect-[4/3] overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-gray-900/80 via-transparent to-transparent opacity-100 transition-opacity duration-300"></div>
